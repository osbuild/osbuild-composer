...
// Returns an *awsupload.AWS object with the credentials of the request. If they are not accessible, then try to use the
// one obtained in the worker configuration
