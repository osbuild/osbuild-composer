...
func main() {
	...
	// If the credentials are not provided in the configuration, then the worker will look in $HOME/.aws/credentials or
	// at the file pointed by the "AWS_SHARED_CREDENTIALS_FILE" variable
	var awsCredentials = ""
	if config.AWS != nil {
