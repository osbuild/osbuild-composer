...
IMAGES_VERSION=$(echo "$COMPOSER_DEPS" | sed -n 's|^\t\+dep\t\+github\.com/osbuild/image-builder\t\+\(v[0-9.a-zA-Z-]\+\)\t\+$|\1|p')
...
greenprint "INFO: Using osbuild/image-builder version to check repo configs: $IMAGES_VERSION"
