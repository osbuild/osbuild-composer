...
case "${ID}-${VERSION_ID}" in
    rhel-9*)
        ...
        ;;
    rhel-10*)
        VIRT_BASEOS_REPO_URL="http://download.devel.redhat.com/rhel-9/nightly/RHEL-9/latest-RHEL-9.9.0/compose/BaseOS/x86_64/os/"
        VIRT_APPSTREAM_REPO_URL="http://download.devel.redhat.com/rhel-9/nightly/RHEL-9/latest-RHEL-9.9.0/compose/AppStream/x86_64/os/"
        ;;
    *)
