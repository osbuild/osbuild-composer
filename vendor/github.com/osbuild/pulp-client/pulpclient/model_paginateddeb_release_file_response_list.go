...
func (o *PaginateddebReleaseFileResponseList) UnmarshalJSON(bytes []byte) (err error) {
	varPaginateddebReleaseFileResponseList := _PaginateddebReleaseFileResponseList{}

	if err = json.Unmarshal(bytes, &varPaginateddebReleaseFileResponseList); err == nil {
