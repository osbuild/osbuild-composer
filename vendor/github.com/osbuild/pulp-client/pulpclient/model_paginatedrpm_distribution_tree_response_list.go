...
func (o *PaginatedrpmDistributionTreeResponseList) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedrpmDistributionTreeResponseList := _PaginatedrpmDistributionTreeResponseList{}

	if err = json.Unmarshal(bytes, &varPaginatedrpmDistributionTreeResponseList); err == nil {
