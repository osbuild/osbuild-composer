...
type AnsibleCollectionRemoteResponse struct {
	...
	LastSyncTask *TaskResponse `json:"last_sync_task,omitempty"`
...
// SetLastSyncTask gets a reference to the given TaskResponse and assigns it to the LastSyncTask field.
...
func (o *AnsibleCollectionRemoteResponse) UnmarshalJSON(bytes []byte) (err error) {
	varAnsibleCollectionRemoteResponse := _AnsibleCollectionRemoteResponse{}

	if err = json.Unmarshal(bytes, &varAnsibleCollectionRemoteResponse); err == nil {
