...
func (o *PaginatedcertguardX509CertGuardResponseList) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedcertguardX509CertGuardResponseList := _PaginatedcertguardX509CertGuardResponseList{}

	if err = json.Unmarshal(bytes, &varPaginatedcertguardX509CertGuardResponseList); err == nil {
