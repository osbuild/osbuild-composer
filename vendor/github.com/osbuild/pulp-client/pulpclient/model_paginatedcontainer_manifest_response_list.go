...
func (o *PaginatedcontainerManifestResponseList) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedcontainerManifestResponseList := _PaginatedcontainerManifestResponseList{}

	if err = json.Unmarshal(bytes, &varPaginatedcontainerManifestResponseList); err == nil {
