...
func (o *PaginatedcertguardRHSMCertGuardResponseList) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedcertguardRHSMCertGuardResponseList := _PaginatedcertguardRHSMCertGuardResponseList{}

	if err = json.Unmarshal(bytes, &varPaginatedcertguardRHSMCertGuardResponseList); err == nil {
