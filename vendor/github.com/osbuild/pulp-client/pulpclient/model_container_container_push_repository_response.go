...
func (o *ContainerContainerPushRepositoryResponse) UnmarshalJSON(bytes []byte) (err error) {
	varContainerContainerPushRepositoryResponse := _ContainerContainerPushRepositoryResponse{}

	if err = json.Unmarshal(bytes, &varContainerContainerPushRepositoryResponse); err == nil {
