...
type _PaginatedGalaxyCollectionResponseList PaginatedGalaxyCollectionResponseList
...
func (o *PaginatedGalaxyCollectionResponseList) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedGalaxyCollectionResponseList := _PaginatedGalaxyCollectionResponseList{}

	if err = json.Unmarshal(bytes, &varPaginatedGalaxyCollectionResponseList); err == nil {
		*o = PaginatedGalaxyCollectionResponseList(varPaginatedGalaxyCollectionResponseList)
	}
