...
func (o *PaginatedContentRedirectContentGuardResponseList) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedContentRedirectContentGuardResponseList := _PaginatedContentRedirectContentGuardResponseList{}

	if err = json.Unmarshal(bytes, &varPaginatedContentRedirectContentGuardResponseList); err == nil {
