...
func (o *PaginatedMultipleArtifactContentResponseList) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedMultipleArtifactContentResponseList := _PaginatedMultipleArtifactContentResponseList{}

	if err = json.Unmarshal(bytes, &varPaginatedMultipleArtifactContentResponseList); err == nil {
