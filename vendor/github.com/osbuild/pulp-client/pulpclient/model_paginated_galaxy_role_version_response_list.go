...
func (o *PaginatedGalaxyRoleVersionResponseList) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedGalaxyRoleVersionResponseList := _PaginatedGalaxyRoleVersionResponseList{}

	if err = json.Unmarshal(bytes, &varPaginatedGalaxyRoleVersionResponseList); err == nil {
