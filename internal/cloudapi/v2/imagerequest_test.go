...
func TestGetTargets(t *testing.T) {
	...
	testCases := map[string]testCase{
		...
		"everything-network-installer:default": {
			imageType:      ImageTypesEverythingNetworkInstaller,
			targets:        nil,
			includeDefault: true,
			expected:       []target.TargetName{target.TargetNameAWSS3},
		},
		"everything-network-installer:s3": {
			imageType:      ImageTypesEverythingNetworkInstaller,
			targets:        []UploadTypes{UploadTypesAwsS3},
			includeDefault: false,
			expected:       []target.TargetName{target.TargetNameAWSS3},
		},
		"everything-network-installer:s3+default": {
			imageType:      ImageTypesEverythingNetworkInstaller,
			targets:        []UploadTypes{UploadTypesAwsS3},
			includeDefault: true,
			expected:       []target.TargetName{target.TargetNameAWSS3, target.TargetNameAWSS3},
		},
		"everything-network-installer:local": {
			imageType:      ImageTypesEverythingNetworkInstaller,
			targets:        []UploadTypes{UploadTypesLocal},
			includeDefault: false,
			expected:       []target.TargetName{target.TargetNameWorkerServer},
		},
		"server-network-installer:default": {
			imageType:      ImageTypesServerNetworkInstaller,
			targets:        nil,
			includeDefault: true,
			expected:       []target.TargetName{target.TargetNameAWSS3},
		},
		"server-network-installer:s3": {
			imageType:      ImageTypesServerNetworkInstaller,
			targets:        []UploadTypes{UploadTypesAwsS3},
			includeDefault: false,
			expected:       []target.TargetName{target.TargetNameAWSS3},
		},
		"server-network-installer:s3+default": {
			imageType:      ImageTypesServerNetworkInstaller,
			targets:        []UploadTypes{UploadTypesAwsS3},
			includeDefault: true,
			expected:       []target.TargetName{target.TargetNameAWSS3, target.TargetNameAWSS3},
		},
		"server-network-installer:local": {
			imageType:      ImageTypesServerNetworkInstaller,
			targets:        []UploadTypes{UploadTypesLocal},
			includeDefault: false,
			expected:       []target.TargetName{target.TargetNameWorkerServer},
