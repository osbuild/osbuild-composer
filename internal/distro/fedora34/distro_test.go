...
func TestDistro_ManifestError(t *testing.T) {
	...
	for _, archName := range f34distro.ListArches() {
		arch, _ := f34distro.GetArch(archName)
...
func TestFedora34_ListArches(t *testing.T) {
	distro := fedora34.New()
	arches := distro.ListArches()
	assert.Equal(t, []string{"aarch64", "x86_64"}, arches)
}

func TestFedora34_GetArch(t *testing.T) {
	distro := fedora34.New()
	arches := []struct {
		name          string
		errorExpected bool
...
func TestFedora34_Name(t *testing.T) {
	distro := fedora34.New()
	assert.Equal(t, "fedora-34", distro.Name())
}

func TestFedora34_ModulePlatformID(t *testing.T) {
	distro := fedora34.New()
	assert.Equal(t, "platform:f34", distro.ModulePlatformID())
}

func TestFedora34_KernelOption(t *testing.T) {
	distro_test_common.TestDistro_KernelOption(t, fedora34.New())
}
