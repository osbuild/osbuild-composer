...
type ImageType interface {
	...
	Manifest(b *blueprint.Blueprint, options ImageOptions, repos []rpmmd.RepoConfig, seed int64, pkgResolver PackageResolver, contResolver ContainerResolver) (Manifest, []string, error)
}

type PackageResolver func(pkgSets map[string][]rpmmd.PackageSet) (map[string][]rpmmd.PackageSpec, error)

type ContainerResolver func(source, name string, tlsVerify *bool) (container.Spec, error)
