...
type ImageType interface {
	...
	Manifest(b blueprint.Blueprint, options ImageOptions, repos []rpmmd.RepoConfig, containers []container.Spec, seed int64) (*manifest.Manifest, map[string][]rpmmd.PackageSet, []string, error)
}
