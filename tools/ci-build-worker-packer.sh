...
RH_ORG_ID=${PACKER_ORG_ID:-}
RH_ACTIVATION_KEY=${PACKER_ACTIVATION_KEY:-}

export COMMIT_SHA COMMIT_BRANCH SKIP_CREATE_AMI BUILD_RPMS ANSIBLE_TAGS PACKER_ONLY_EXCEPT RH_ORG_ID RH_ACTIVATION_KEY
